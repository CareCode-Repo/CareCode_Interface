...
public class CareFacilityController extends BaseController {
    ...
    public ResponseEntity<CareFacilityResponse.CareFacility> getFacilityById(@Parameter(description = "시설 ID", required = true) @PathVariable Long id) {
    ...
    public ResponseEntity<List<CareFacilityResponse.CareFacility>> getFacilitiesByType(@Parameter(description = "시설 유형 (KINDERGARTEN: 유치원, DAYCARE: 어린이집, PLAYGROUP: 놀이방, NURSERY: 보육원, OTHER: 기타)", required = true) @PathVariable FacilityType facilityType) {
    ...
    public ResponseEntity<List<CareFacilityResponse.CareFacility>> getFacilitiesByLocation(@Parameter(description = "지역명", required = true) @PathVariable String location) {
    ...
    public ResponseEntity<List<CareFacilityResponse.CareFacility>> getFacilitiesByAgeRange(@Parameter(description = "최소 연령", required = true) @RequestParam Integer minAge,
    ...
    public ResponseEntity<List<CareFacilityResponse.CareFacility>> getFacilitiesByOperatingHours(@Parameter(description = "운영 시간", required = true) @RequestParam String operatingHours) {
    ...
    public ResponseEntity<List<CareFacilityResponse.CareFacility>> getPopularFacilities(@Parameter(description = "조회할 시설 수", example = "10") @RequestParam(defaultValue = "10") Integer limit) {
    ...
    public ResponseEntity<List<CareFacilityResponse.CareFacility>> getNewFacilities(@Parameter(description = "조회할 시설 수", example = "10") @RequestParam(defaultValue = "10") Integer limit) {
    ...
    public ResponseEntity<List<CareFacilityResponse.CareFacility>> getFacilitiesWithinRadius(@Parameter(description = "위도", required = true) @RequestParam Double latitude,
    ...
    public ResponseEntity<CareFacilityResponse.CareFacilityList> searchFacilities(@Parameter(description = "검색 조건", required = true) @RequestBody CareFacilityRequest.Search requestDto) {
    ...
    public ResponseEntity<CareFacilityBookingDto.BookingResponse> createBooking(@Parameter(description = "시설 ID", required = true) @PathVariable Long facilityId,
    ...
    public ResponseEntity<CareFacilityBookingDto.BookingResponse> getBookingById(@Parameter(description = "예약 ID", required = true) @PathVariable Long bookingId,
                                                                                 @AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<List<CareFacilityBookingDto.BookingResponse>> getUserBookings(@AuthenticationPrincipal UserDetails userDetails) {
    ...
    public ResponseEntity<List<CareFacilityBookingDto.BookingResponse>> getFacilityBookings(@Parameter(description = "시설 ID", required = true) @PathVariable Long facilityId) {
    ...
    public ResponseEntity<CareFacilityBookingDto.BookingResponse> updateBookingStatus(@Parameter(description = "예약 ID", required = true) @PathVariable Long bookingId,
    ...
    public ResponseEntity<CareFacilityBookingDto.BookingResponse> updateBooking(@Parameter(description = "예약 ID", required = true) @PathVariable Long bookingId,
    ...
    public ResponseEntity<List<CareFacilityBookingDto.BookingResponse>> getTodayBookingsByFacility(@Parameter(description = "시설 ID", required = true) @PathVariable Long facilityId) {
