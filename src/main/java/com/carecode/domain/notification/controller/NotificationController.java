...
public class NotificationController extends BaseController {
    ...
    @LogExecutionTime
    @Operation(summary = "알림 읽음 처리", description = "알림을 읽음 상태로 변경")
    ...
    @GetMapping("/unread")
    @LogExecutionTime
    @Operation(summary = "읽지 않은 알림 조회", description = "사용자의 읽지 않은 알림 목록 조회")
    ...
    @LogExecutionTime
    @Operation(summary = "특정 알림 타입 설정 조회")
    ...
    @LogExecutionTime
    @Operation(summary = "전체 알림 설정 업데이트", description = "사용자의 모든 알림 설정을 한 번에 업데이트")
    ...
    @LogExecutionTime
    @Operation(summary = "알림 설정 저장", description = "사용자의 알림 설정을 저장")
    ...
    @LogExecutionTime
    @Operation(summary = "채널별 설정 업데이트", description = "사용자의 특정 알림 타입의 채널별 설정을 업데이트")
    ...
    @LogExecutionTime
    @Operation(summary = "모든 알림 설정 비활성화")
    ...
    @LogExecutionTime
    @Operation(summary = "알림 설정 초기화", description = "사용자의 알림 설정을 기본값으로 초기화")
    ...
    @LogExecutionTime
    @Operation(summary = "알림 읽음 처리", description = "알림을 읽음으로 표시")
    ...
    @GetMapping("/type")
    @LogExecutionTime
    @Operation(summary = "알림 타입별 조회", description = "특정 타입의 알림 조회")
    ...
    @LogExecutionTime
    @Operation(summary = "기간별 알림 조회", description = "특정 기간의 알림 조회")
    ...
    @LogExecutionTime
    @Operation(summary = "읽음 상태별 알림 개수 조회")
