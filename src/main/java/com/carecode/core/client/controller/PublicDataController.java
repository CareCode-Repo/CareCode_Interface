...
public class PublicDataController {
    ...
    @Operation(summary = "육아 시설 정보 조회", description = "지역별 육아 관련 시설 정보 조회")
    ...
    @Operation(summary = "소아과 병원 정보 조회")
    ...
    @Operation(summary = "육아 지원금 정보 조회")
    ...
    @Operation(summary = "커스텀 API 호출", description = "사용자 정의 엔드포인트로 공공데이터 API를 호출")
